...
const SettingsSidebar = () => {
    ...
    return (
        <>
            ...
            {/* Desktop Sidebar */}
            <aside className="md:sticky hidden md:block top-24 h-fit min-w-[240px] bg-background rounded-2xl border border-border divide-y divide-border overflow-hidden">
                {/* User Header */}
                <div className="p-3">
                    <Link 
