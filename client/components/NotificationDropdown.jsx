...
const NotificationDropdown = ({notifications , markAsRead})=>{
    ...
    return <div className="min-w-80 max-w-full max-h-80 overflow-y-auto fixed md:absolute  right-0 mt-3  bg-background border border-border rounded-xl shadow-xl animate-in fade-in zoom-in duration-200 divide-y divide-border">
